        ...
        >
          {navItems.map((navItem, idx) => (
            <a
              ...
              href={navItem.link}
              className={cn(
                "relative dark:text-neutral-50 pl-3 items-center flex text-neutral-600 dark:hover:text-neutral-300 hover:text-neutral-500",
                navItem.name === "Trades" && 
          ...
          <a className="px-1 py-2 rounded-full text-white">
